...
def arxiv_task(split, node_split="", split_labels=False, train_cap = 3, label_set = range(40), linear_probe=False, ogb_root="dataset"):
    ...
    if not split_labels:
        ...
        print("USING NORMAL TEST LABELS")
        # Label split by TENT
