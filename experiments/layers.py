...
def get_module_list(module_string, emb_dim, edge_attr_dim, input_dim, dropout, reset_after_layer, attention_mask_scheme, has_final_back, msg_pos_only, batch_norm_metagraph=True, batch_norm_encoder=True, gnn_use_relu=False, connect_same_label_nodes=False):
    '''
        ...
        if layer[0] == "S":
            ...
            module_list.append(
                MetaGNN(emb_dim=emb_dim, edge_attr_dim=2, n_layers=n_layer, heads=8, dropout = dropout, has_final_back=has_final_back,
                        ...
                        connect_same_label_nodes=connect_same_label_nodes)
            )
        elif layer[0] == "W":
